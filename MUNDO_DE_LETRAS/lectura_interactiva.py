...
class LecturaInteractiva:
    def __init__(self, master, titulo, lectura_path, preguntas_path, imagen_path=None, volver_func=None):
        ...
        # Configuración de estilos (manteniendo los originales)
        self._configurar_estilos()
        self.cargar_datos()
        self.construir_interfaz()

    def _configurar_estilos(self):
        """Configura los estilos visuales como en la versión original"""
        ctk.set_appearance_mode("light")
        ctk.set_default_color_theme("blue")
        self.master.configure(fg_color="white")

    def cargar_datos(self):
        """Carga los datos de lectura y preguntas con manejo de errores"""
        try:
    ...
    def construir_interfaz(self):
        ...
        # Frame de contenido (imagen + texto)
        self._crear_frame_contenido()
        
        # Footer con botones (estilo original)
        self._crear_footer()

    def _crear_titulo(self):
        """Crea el título con el estilo original"""
    ...
    def _crear_frame_contenido(self):
        """Crea el frame de contenido con imagen y texto"""
    ...
    def _crear_texto_lectura(self, parent_frame):
        """Crea el widget de texto de lectura"""
    ...
    def _crear_footer(self):
        ...
        # Botón continuar (estilo original)
        ...
        # Botón regresar (estilo original)
    ...
    def continuar(self):
        """Muestra la primera pregunta (estilo original)"""
    ...
    def _configurar_ui_preguntas(self):
        """Configura la UI para mostrar preguntas (estilo original)"""
    ...
    def mostrar_pregunta(self):  
        """Muestra la pregunta actual (estilo original)"""
    ...
    def verificar_respuesta(self, indice):
        """Verifica la respuesta y avanza (estilo original)"""
        if not self.preguntas or self.pregunta_actual >= len(self.preguntas):
            return
    ...
    def finalizacion(self):
        """Muestra la pantalla final (estilo original)"""
    ...
    def _configurar_pantalla_resultados(self):
        """Configura la pantalla de resultados finales (estilo original)"""
    ...
    def _crear_frame_imagen(self, parent_frame):
        """Crea el frame con la imagen de felicitación (estilo original)"""
    ...
    def _crear_frame_resultados(self, parent_frame):
        """Crea el frame con los resultados (estilo original)"""
    ...
    def _crear_frame_confirmacion(self):
        """Crea un frame de confirmación que se superpone a la ventana principal"""
    ...
    def _confirmar_salida(self):
        """Acción al confirmar la salida: reinicia respuestas y vuelve"""
    ...
    def _cancelar_salida(self):
        """Acción al cancelar la salida: solo cierra el frame de confirmación"""
        self._eliminar_frame_confirmacion()
