...
class InicioFrame(BaseFrame):
    def __init__(self, master, show_frame_callback):
        ...
        # Imágenes
        #self.nino = Image.open("C:\\Users\\Huich\\Downloads\\Ing\\recursos\\nino.png")
        self.nino = Image.open("C:\\Users\\RODRIGUEZMLDO\\Documents\\LecturasPython\\recursos\\nino.png")
        self.nino = self.nino.resize((int(self.width/5), int(self.height/1.66)))
        self.tk_nino = ImageTk.PhotoImage(self.nino)

        #self.globo = Image.open("C:\\Users\\Huich\\Downloads\\Ing\\recursos\\globo.png")
        self.globo = Image.open("C:\\Users\\RODRIGUEZMLDO\\Documents\\LecturasPython\\recursos\\globo.png")
        ...
        #self.nina = Image.open("C:\\Users\\Huich\\Downloads\\Ing\\recursos\\nina.png")
        self.nina = Image.open("C:\\Users\\RODRIGUEZMLDO\\Documents\\LecturasPython\\recursos\\nina.png")
        ...
        # Función para dividir texto en líneas que caben
        def crear_texto_multilinea(canvas, texto, max_width, y_pos, tamano_fuente):
            ...
            for i, linea in enumerate(lineas):
                ...
                for j, palabra in enumerate(linea):
                    color_idx = (len(lineas[0])*i + j) % len(colores)
                    ...
                    current_x += canvas.bbox(palabra_id)[2] - canvas.bbox(palabra_id)[0]
